defmodule Collector.DataWarehouse.Subscriber.DynamicSupervisor do
  ...
  alias Core.Repo
  alias Collector.DataWarehouse.Schema.CollectorSetting
  alias Collector.DataWarehouse.Subscriber.Worker
  ...
  def autostart_workers do
    Repo.all(from(s in CollectorSetting, where: s.status == :on, select: s.topic))
