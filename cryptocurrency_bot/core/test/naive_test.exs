defmodule NaiveTest do
  ...
  alias Collector.DataWarehouse.Schema.Order
  alias Strategy.Naive.Schema.Setting, as: TraderSetting
  ...
  test "Naive trader full trade (buy + sell) test" do
    ...
    Strategy.Naive.start_trading(symbol)
    Collector.DataWarehouse.start_storing("ORDERS", symbol)
    :timer.sleep(5000)
    ...
    [buy_1, sell_1, buy_2] = Core.Repo.all(query)
